...
<ul>
  <li style={{ listStyleType: 'disc' }}>
    <b style={{ backgroundColor: '#B5E582' }}>ፖስፖርት ማደስ / Renewals: </b>ለነባር ፓስፖርትዎ የእድሳት ሂደቱን እናስተካክላለን። We streamline the renewal process for your existing passport, ensuring a smooth and timely experience.
  </li>
  <li style={{ listStyleType: 'disc' }}>
    <b style={{ backgroundColor: '#B5E582' }}>አዲስ ፖስፖርት ማውጣት / First-Time Applications: </b>ሰነዶችን ከመሰብሰብ ጀምሮ ማመልከቻዎን እስከ ማስገባት ድረስ የመጀመሪያ ፓስፖርትዎን በማመልከት ሂደት ውስጥ እንመራዎታለን። We guide you through the process of applying for your first passport, from gathering documents to submitting your application.
  </li>
  <li style={{ listStyleType: 'disc' }}>
    <b style={{ backgroundColor: '#B5E582' }}>ፖስፖርት ለልጆች / Child Passports: </b>ሁሉም አስፈላጊ መስፈርቶች መሟላታቸውን በማረጋገጥ ለልጆች ፓስፖርት በማመልከት እንረዳለን። We assist with applying for passports for children, ensuring all necessary requirements are met.
  </li>
  <li style={{ listStyleType: 'disc' }}>
    <b style={{ backgroundColor: '#B5E582' }}>የጠፉ ፖስፖርት ማውጣት / Lost or Damaged Passports: </b>የጠፋ ወይም የተበላሸ ፓስፖርት ሪፖርት ለማድረግ እና ለመተካት ሂደቱን እናግዝዎታለን። We help you navigate the process of reporting a lost or damaged passport and applying for a replacement.
  </li>
</ul>
<h2 className="services text-center">
...
Ready to travel? Get started today!</p>
